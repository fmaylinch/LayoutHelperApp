...
+ (void)configureScrollView:(UIScrollView*)scrollView contentView:(UIView*)contentView mainView:(UIView*)mainView  __attribute__((deprecated)); // Use configureVerticalScrollView

// Configures a vertical scroll view. Adds contentView to scrollView and returns a container view you should lay out.
+ (UIView*)configureVerticalScrollView:(UIScrollView*)scrollView contentView:(UIView*)contentView;

// Configures a vertical scroll view. Adds contentView to scrollView and makes it as wide as the container (which is the view that contains the scrollView).
+ (void)configureVerticalScrollView:(UIScrollView*)scrollView contentView:(UIView*)contentView container:(UIView*)container;

// Configures a horizontal scroll view. Adds contentView to scrollView and returns a container view you should lay out.
+ (UIView*)configureHorizontalScrollView:(UIScrollView*)scrollView contentView:(UIView*)contentView;

// Configures a horizontal scroll view. Adds contentView to scrollView and makes it as high as the container.
